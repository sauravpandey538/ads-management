...
export const services: Record<ServiceSlug, ServiceData> = {
  meta: {
    ...
    shortName: "Meta",
    tabLabel: "Meta",
    headline: "Meta ads that fill your demo calendar — not your retargeting graveyard",
    subheadline:
      "Facebook & Instagram campaigns built for SaaS: lookalikes from closed-won, creative sprints, and exclusions that stop paying for the same click twice.",
    icon: "meta",
    color: "bg-[#0081FB]/15",
    badgeVariant: "flag",
  ...
  instagram: {
    ...
    shortName: "Instagram",
    tabLabel: "Instagram",
    headline: "Instagram ads that look native — and convert like landing pages",
    subheadline:
      "Reels, Stories, and feed placements engineered for SaaS: product demos in 15 seconds, social proof hooks, and swipe-up paths that match your offer.",
    icon: "instagram",
  ...
  youtube: {
    ...
    shortName: "YouTube",
    tabLabel: "YouTube",
    headline: "YouTube ads that educate buyers before they ever hit your pricing page",
    subheadline:
      "In-stream, discovery, and Shorts campaigns for SaaS with long sales cycles — product walkthroughs, competitor comparisons, and remarketing viewers into demos.",
    icon: "youtube",
    color: "bg-[#FF0000]/10",
    badgeVariant: "ticket",
  ...
  linkedin: {
    ...
    shortName: "LinkedIn",
    tabLabel: "LinkedIn",
    headline: "LinkedIn ads that reach the exact title signing your checks",
    subheadline:
      "Title, company, seniority, and ABM campaigns for demo-led B2B SaaS — with thought-leader ads and document formats for long evaluation cycles.",
    icon: "linkedin",
    color: "bg-[#0A66C2]/12",
    badgeVariant: "pin",
  ...
  google: {
    ...
    shortName: "Google",
    tabLabel: "Google",
    headline: "Google ads that capture buyers the moment they search for your category",
    subheadline:
      "High-intent search, competitor conquest, and Performance Max with SaaS guardrails — optimized for demos and trials, not junk leads.",
    icon: "google",
    color: "bg-mint/30",
    badgeVariant: "chip",
